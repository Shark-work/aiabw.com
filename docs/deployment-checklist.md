...
- `DEEPSEEK_API_KEY=<recommended for Agent chat>`
- `DEEPSEEK_MODEL=deepseek-chat` (optional)
- `ANTHROPIC_API_KEY=<required for Agent chat (Haiku/Sonnet)>`
- `ANTHROPIC_MODEL_FREE=claude-3-5-haiku-20241022`
- `ANTHROPIC_MODEL_PRO=claude-3-5-sonnet-20241022`
...
- `LLM_PROVIDER=auto` (`auto` | `deepseek` | `anthropic`)
- `OPENAI_API_KEY=<required for Moderation + optional chat>`
